  ...
  return (
    <div className="relative overflow-hidden bg-white">
      ...
      <div className="absolute bottom-[100px] left-[90px] hidden sm:block">
        <Image src="/assets/about/Spiral.png" alt="Spiral Image" width={59} height={128} />
      </div>
      ...
      <section className="relative container mx-auto flex flex-col lg:flex-row items-center justify-center lg:justify-between py-12 gap-10">
        ...
        <div className="relative w-full lg:w-1/2 mt-8 lg:mt-0 text-center lg:text-left px-4">
          ...
          <div className="headline text-2xl md:text-4xl font-bold mt-4">
            <span className="text-[#000]">We’re A Strategic</span> <span className="highlight brown">Digital</span>
            <br />
            <span className="highlight orange">Media</span> <span className="text-[#000]">Agency</span>
          </div>
          ...
          <div className="flex flex-col items-center lg:flex-row lg:items-start justify-center lg:justify-start space-y-6 lg:space-y-0 lg:space-x-8 mt-8">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-700 max-w-[200px] mx-auto lg:mx-0">Successful Marketing Campaigns</p>
            </div>
            <div className="text-center lg:text-left">
              <h4 className="text-3xl md:text-4xl font-bold text-gray-800 stylish-text">75%</h4>
              <p className="text-gray-700 max-w-[200px] mx-auto lg:mx-0">Average Increase In Website Traffic</p>
            </div>

            {/* Decorative Circle - Hidden on Mobile */}
            <div className="hidden sm:block">
              <Image src="/assets/about/circel.png" alt="Circle" width={100} height={100} />
            </div>
          </div>
      ...
      <div className="absolute right-0 bottom-[150px] lg:bottom-[190px] hidden sm:block">
        <Image src="/assets/about/Heavy-Waves.png" alt="Heavy Waves Image" width={195} height={40} />
      </div>
    </div>
  );
}
