        ...
        <div className="max-w-[1350px] mx-auto flex items-center justify-between px-4 lg:px-16 py-2 gap-4 overflow-hidden">
          ...
          <div className="flex items-center gap-4 text-sm flex-nowrap">
            <div className="flex items-center gap-2">
              <Image src="/assets/header/phone.png" alt="phone" width={16} height={16} />
              <a href="tel:+448001957512" className="text-[10px] sm:text-sm md:text-base whitespace-nowrap truncate">
                +44 800 195 7512
              </a>
            </div>
            <div className="flex items-center gap-2">
              <Image src="/assets/header/message.png" alt="message" width={16} height={16} />
              <a
          ...
          <div className="flex items-center gap-2 sm:gap-3 text-sm flex-nowrap">
            <a href="#" className="hover:text-orange-500">
              <Image src="/assets/header/facebook.png" alt="FaceBook" width={7} height={12} />
            </a>
            <a href="#" className="hover:text-orange-500">
              <Image src="/assets/header/twitter.png" alt="Twitter" width={10} height={12} />
            </a>
            <a href="#" className="hover:text-orange-500">
              <Image src="/assets/header/linkedinIn.png" alt="LinkedIn" width={10} height={12} />
            </a>
            <a href="#" className="hover:text-orange-500">
              <Image src="/assets/header/youtube.png" alt="YouTube" width={12} height={12} />
            </a>
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#eff1fe] text-black rounded-bl-[20px] rounded-br-[20px]">
        <div className="max-w-[1350px] mx-auto flex items-center justify-between py-4 px-4 lg:px-16 rounded-bl-[20px] rounded-br-[20px]">
          ...
          <div className="text-2xl font-bold">
            <Image src="/assets/header/logo.png" alt="webxcell" width={187} height={38} />
          </div>

          {/* Hamburger Menu for Mobile */}
          <button className="lg:hidden text-black focus:outline-none" onClick={toggleMobileMenu}>
            <Image
              src={isMobileMenuOpen ? '/assets/menu/close.png' : '/assets/menu/open.png'}
              alt="menu"
          ...
          <nav className="hidden lg:flex gap-8 font-medium">
            ...
            <div className="flex items-center">
              <Image src="/assets/header/search.png" alt="search" width={16} height={16} />
            </div>
          </nav>
